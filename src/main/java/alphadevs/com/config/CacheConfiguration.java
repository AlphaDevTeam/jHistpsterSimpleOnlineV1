...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jHistpsterSimpleOnlineV1");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jHistpsterSimpleOnlineV1");
        ...
        config.getMapConfigs().put("alphadevs.com.domain.*", initializeDomainMapConfig(jHipsterProperties));
